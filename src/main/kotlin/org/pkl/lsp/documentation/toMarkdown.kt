  ...
  when (this) {
    ...
    is PklParameter ->
      if (isUnderscore) {
        ...
        typedIdentifier!!.doRenderMarkdown(originalNode, context)
      }
    ...
    is PklModule -> declaration?.doRenderMarkdown(originalNode, context) ?: "module $moduleName"
    is PklModuleDeclaration ->
      buildString {
        append(modifiers.render())
        append("module ")
        // can never be null
        append(moduleHeader!!.doRenderMarkdown(originalNode, context))
      }
    is PklModuleHeader ->
      buildString {
    ...
    is PklTypeAlias -> typeAliasHeader.doRenderMarkdown(originalNode, context)
